...
/// (`assets/briysce-wordmark-paper.svg`, "Paper on Ink" per
...
/// approximates it with a bold geometric sans (Montserrat Bold) in the same
/// white, tracked out like a logotype sub-label — same treatment as Swift
/// Document Generator's splash screen, so both apps' briysce-apps signature
/// looks identical.
      ...
      children: [
        SizedBox(
          ...
          child: SvgPicture.asset(
            'assets/briysce-wordmark-paper.svg',
            fit: BoxFit.contain,
