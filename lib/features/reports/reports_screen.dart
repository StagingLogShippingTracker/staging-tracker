  ...
  Widget build(BuildContext context) {
    ...
    return ColoredBox(
      ...
      child: AsyncPanel(
        ...
        isEmpty: data.staging.isEmpty && data.shipped.isEmpty,
        error: data.error,
        onRetry: () => ref.read(appDataProvider.notifier).refresh(),
        emptyTitle: 'No operational data yet',
        emptyMessage:
            'Reports will populate as staging and shipping activity is recorded.',
        child: content,
      ),
    );
  }
