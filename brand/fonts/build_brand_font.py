#!/usr/bin/env python3
"""Build Swift Staging Brand font from logo PNG — exact S/L/T + pattern-matched alphabet."""
...
def build_font():
    ...
    fb.setupNameTable({
        "familyName": "Swift Staging Brand",
        "styleName": "Regular",
        "uniqueFontIdentifier": "SwiftStagingBrand-Regular",
        "fullName": "Swift Staging Brand Regular",
        "psName": "SwiftStagingBrand-Regular",
        "version": "Version 1.000",
    })
    fb.setupPost()

    ttf_path = OUT_DIR / "SwiftStagingBrand-Regular.ttf"
    woff2_path = OUT_DIR / "SwiftStagingBrand-Regular.woff2"
    fb.save(ttf_path)
