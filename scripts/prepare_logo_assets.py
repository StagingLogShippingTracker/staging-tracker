...
Outputs:
  assets/swift-staging-log-logo-source.png       — archived full source
  assets/swift-staging-log-wordmark-white.png    — full wordmark, transparent, high-res UI
  assets/swift-staging-log-mark-s.png            — S + swish only, transparent, high-res UI
  assets/swift-staging-log-app-icon.png          — S + swish on #0A1017 rounded square
  assets/swift-staging-log-splash-wordmark.png   — full wordmark on #091019 (Android/Wear splash)
  assets/swift-staging-log-splash-banner.png     — wide splash banner helper
...
SRC_CANDIDATES = [
    ...
    ASSETS / "swift-staging-log-logo-source.png",
    BRAND_SOURCE / "swift-staging-log-logo-full.png",
]
...
def make_app_icon(mark: Image.Image, size: int = 1024) -> Image.Image:
    ...
    # Does not rewrite assets/swift-staging-log-mark-s.png or UI wordmarks.
...
def main() -> None:
    ...
    # Archive source
    archived = ASSETS / "swift-staging-log-logo-source.png"
    raw.save(archived, optimize=True)
    raw.save(BRAND_SOURCE / "swift-staging-log-logo-full.png", optimize=True)
    ...
    wm_path = ASSETS / "swift-staging-log-wordmark-white.png"
    ...
    wordmark_hd.save(ASSETS / "swift-staging-log-wordmark.png", optimize=True)
    ...
    splash_banner_path = ASSETS / "swift-staging-log-splash-banner.png"
